 ...
 * @author Natesan
 */
public class profileFram extends javax.swing.JFrame {

    /**
     * Creates new form profileFram
     */
    public profileFram() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(profileFram.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new profileFram().setVisible(true);
