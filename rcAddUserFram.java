 ...
 * @author Natesan
 */
public class rcAddUserFram extends javax.swing.JFrame {

    /**
     * Creates new form rcAddUserFram
     */
    public rcAddUserFram() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        new Client("10:"+firstname+","+lastname+","+DOB+","+email+","+uid+","+address+","+phone+","+room+","+hall+","+primarykey);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rcAddUserFram.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new rcAddUserFram().setVisible(true);
            }
        });
    }
